...
const sessdata = config.SESSION_ID.replace("Weed-Tech~", '');
...
console.log("CONNECTING Damon-XMD 🧬...");
...
console.log('Damon-XMD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ Damon-XMD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*
...
if(senderNumber.includes("50939032060")){
if(isReact) return
m.react("🦋")
   }
...
app.get("/", (req, res) => {
res.send("HEY, DAMON-XMD STARTED ✅");
});
